...
class ReminderAdapter(private var reminders: List<Reminder>, private var filteredReminders: List<Reminder>, private val imagePickerListener: ImagePickerListener) : RecyclerView.Adapter<ReminderAdapter.ReminderViewHolder>() {
    ...
    class ReminderViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        val reminderItemContainer: ConstraintLayout = view.findViewById(R.id.reminderItemContainer)
        init {
    ...
    private fun removeReminderAt(position: Int) {
        ...
        val realIndex = reminders.indexOf(filteredReminders[position])
        reminders = reminders.filterIndexed { index, _ -> index != realIndex }
    ...
    private fun completeReminderAt(position: Int) {
        ...
        val realIndex = reminders.indexOf(filteredReminders[position])
        val reminder = reminders[realIndex]
    ...
    fun updateData(newReminders: List<Reminder>) {
        ...
        filteredReminders = reminders.filter { !it.completed }
